...
export default function Navbar() {
  return (
    <div className="flex w-full items-center justify-center gap-4">
      <nav className=" text-white pt-2 flex items-center justify-center font-display gap-20">
        {/* Left: Logo */}
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="text-xs cursor-pointer flex items-center gap-1 text-white">
          EN <span>▼</span>
        </div>
      </div>
    </div>
