...
export default function BottomMenu() {
  return (
    <div className="flex justify-around h-fit mb-5 gap-3 p-2">
      {navItems.map((items) => (
        <div className="relative w-full bg-no-repeat bg-cover h-full pb-8 pt-5  bg-center bg-[url('../../public/assets/images/png/tab-one.png')] transition-all duration-300 ease-in-out  hover:bg-[url('../../public/assets/images/png/tab-active.png')] cursor-pointer">
