            ...
            <div className="w-full h-full div-bg div-cut-top rounded-lg">
              ...
              <div className="w-full h-full flex pt-5">
                <div className="w-2/4 h-full">
                  <img src="/assets/images/gif/skate-man.gif"></img>
                </div>
                <div className="w-full h-full flex flex-col gap-4">
                  <div className="w-full text-[29px] uppercase">
                    Solaxy Crypto Presale
                    <p className="text-blue-500">The Solana L2</p>
                  </div>
                  <div className="flex flex-wrap items-center gap-2">
                    {[
                      "Solana's first Layer 2 Chain",
                      "Infinite scale",
                      "best meme coin",
                      ...
                      <div
                        key={index}
                        className="text-sm w-fit text-center flex justify-center items-center h-10 border-2 p-4 rounded-3xl uppercase"
                      >
                        {item}
                      </div>
                    ))}
                  ...
                  <div className="text-xl font-semibold capitalize font-sans">
                    ...
                    designed to unlock the full potential of the Solana
                    ecosystem. Experience unmatched scalability and a
                    future-proof network built to redefine Solana's
                    capabilities.
                  </div>
                  <div className="flex justify-start items-center mt-8 gap-3">
                    ...
                    <p
                      className="font-bold text-xl bg-gradient-to-b from-[#7082f9e6] to-[#11c3f0da] bg-clip-text text-transparent"
                      style={{
                        filter:
        ...
        <div className="w-1/2 flex flex-col h-fit relative justify-start p-2">
            ...
            <div className="w-full h-32 p-2 flex flex-col gap-1">
              ...
              <div className="flex flex-col gap-1">
                <div className="flex justify-center items-center gap-3">
                  <p className="text-center text-xs">YOUR PURCHASED SOLX = 0</p>
                  <button
                    onClick={() =>
                      Modal.open(
                ...
                <div className="flex justify-center items-center gap-3">
                  <p className="text-center text-xs">YOUR STAKEABLE SOLX = 0</p>
                  <button
                    onClick={() =>
                      Modal.open(
                        <div className="flex flex-col justify-center text-white items-center gap-4 p-6 bg-blue-950 rounded-3xl">
          ...
          <div className="relative w-full h-14 border-1 border-t-0 border-gray-500 bg-gray-500 div-cut-bottom-2">
            <div className="absolute w-full h-full bg-black div-cut-bottom-2">
              ...
              >
                <img
                  src="/assets/images/png/web3payments.png"
                  width={150}
                  height={150}
